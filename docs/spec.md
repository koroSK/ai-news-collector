...
| 関数 | 役割 |
|------|------|
| `fetch_news()` | Google News RSSから英語・日本語ニュースを取得して返す |
...
### 5.2 `.github/workflows/collect_news.yml`
...
- 収集件数はRSSフィードの返却件数に依存するため、キーワードによっては10件未満になる場合がある
